...
function processEmails() {
  ...
  if (threads != null) {
    ...
    for (var i = threads.length - 1; i >= 0; i--) {
      ...
      var dateEmail = messages[0].getDate();
      if (messages[0].getSubject() == "Mail delivery failed: returning message to sender") {
